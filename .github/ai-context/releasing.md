...
JiraAgilePS delegates release planning and publication to the reusable workflow in [AtlassianPS.Standards](https://github.com/AtlassianPS/AtlassianPS.Standards/blob/master/docs/ReleaseBlueprint.md).
